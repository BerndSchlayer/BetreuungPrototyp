  ...
  (
    ...
    if (opts.length > 0) {
      ...
      React.Children.forEach(children, (child) => {
        if (
          ...
          selectedLabel = React.Children.toArray(
    ...
    const handleSelect = (val: string) => {
      if (typeof onChange === "function") {
        // Künstliches ChangeEvent erzeugen
        const event = {
          target: { value: val },
                      ...
                      return (
                        <div
                          ...
                          className={`px-3 py-2 cursor-pointer hover:bg-blue-50 ${
                            child.props.value === value ? "bg-blue-100" : ""
                          } ${highlighted === idx ? "bg-blue-200" : ""}`}
                          onMouseDown={(e) => {
                            e.preventDefault();
                            handleSelect(
